...
function indexMain()
{
    ...
    echo '<h2 class="toph2index text-center es">
                <spam class="font1 es">Un tercio de la miel comerciada internacionalmente es</spam></h2>
        ...
        <h2 class="toph2index text-center fr">
                <spam class="font1 fr">Un tiers du miel commercialisé à l&apos;international est</spam></h2>
...
function fraudEs()
{
    echo '<h2 class="font1 es">El fraude que atenta contra<br>abejas, biodiversidad y
            apicultores</h2>
        <h2 class="font2 es"><br>¿Cómo es posible?</h2>';
}
function fraudFr()
{
    echo '<h2 class="font1 fr">La fraude qui menace<br>abeilles, biodiversité et apiculteurs</h2>
        <h2 class="font2 fr"><br>Comment est-ce possible?</h2>';
}
function fraudEn()
{
    echo '<h2 class="font1 en">The fraud that threatens<br>bees, biodiversity and beekeepers</h2>
        <h2 class="font2 en"><br>How is it possible?</h2>';
}
...
{
    echo '<div class="col-xs-12 col-sm-6 es">
...
{
    echo '<div class="col-xs-12 col-sm-6 fr">
...
{
    echo '<div class="col-xs-12 col-sm-6 en">
